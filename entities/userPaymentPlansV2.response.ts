...
export interface CreateUserPaymentPlanV2DataResponseJson {
    id: number,
    user_id: number,
    signed_date: string,
    start_date: string,
...
export const createUserPaymentPlanDataResponseJsonSchema: JSONSchemaType<CreateUserPaymentPlanV2DataResponseJson> = {
    type: "object",
    properties: {
    id: { type: "number" },
    user_id: { type: "number" },
